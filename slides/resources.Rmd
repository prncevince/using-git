name: resources
class: nomargin-ul nomargin-h2 nomargin-h3 nomargin-h4 nopadding-h2 split-10
...
- [Git Revision Selection Notation (article)](https://git-scm.com/book/en/v2/Git-Tools-Revision-Selection)
- [Git Revision Selection Notation (man page)](https://git-scm.com/docs/gitrevisions)
]
