...
.row[.content[
### .center[Git Aliases]
A popular "framework" for Zsh, [Oh My Zsh](https://github.com/ohmyzsh/ohmyzsh), contains built in [plugins](https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins) for shell utilities.
<br><br>
